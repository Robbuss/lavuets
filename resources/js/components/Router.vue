\<template>
  <v-app v-if="!loading">
    ...
    <v-content>
      <v-container :class="{'pa-0' : $vuetify.breakpoint.smAndDown, 'fill-height' : authRoutes }">
...
export default class RouterComponent extends Vue {
  ...
  async created() {
    ...
    this.$vuetify.theme.themes.light.secondary = Store.state.layout.secondary_color;
    this.loading = false;
  }
