                      ...
                      >
                        ...
                        <v-card>
                          <v-card-text class="pa-0">
                            <v-color-picker hide-inputs v-model="settings.find((x) => x.key === 'primary_color').value" flat />
                          </v-card-text>
                        </v-card>
                      </v-menu>
                    </template>
                  ...
                  >
                    <template v-slot:prepend>
                      ...
                      >
                        ...
                        <v-card>
                          <v-card-text class="pa-0">
                            <v-color-picker hide-inputs v-model="settings.find((x) => x.key === 'secondary_color').value" flat />
                          </v-card-text>
                        </v-card>
                      </v-menu>
                    </template>
...
export default class Settings extends Vue {
  ...
  onSettingsChanged(){
    console.log('a')
      this.$vuetify.theme.themes.light.primary = this.settings.find((x: any) => x.key === 'primary_color').value
      this.$vuetify.theme.themes.light.secondary = this.settings.find((x: any) => x.key === 'secondary_color').value
  }
