            ...
            <v-row wrap class="text-xs-left">
              ...
              <v-col cols="12">
                ...
                >
                  ...
                  <v-date-picker v-model="contract.start_date" no-title @input="datePicker = false"></v-date-picker>
                </v-menu>
              </v-col>
        ...
        <v-col cols="12" md="4" lg="3" v-if="!loading">
          <v-card flat class="grey lighten-3">
            ...
            >
              ...
              <h3 class="subtitle-1 grey--text" v-if="false">
                Voor de duur van
                <span class="primary--text">{{ contract.period || 'Kies een duur' }}</span>
              </h3>
              <h3 class="subtitle-1 grey--text">
                Begin datum
          ...
          <v-row wrap justify-content>
            ...
            <v-col class="justify-content">
              <img width="100px" :src="customer.logo" />
            </v-col>
          </v-row>
        </v-col>
      </v-row>
...
export default class StepTenant extends Vue {
  ...
  async mounted() {
    this.customer = (await axios.get("/api/book-data/customer")).data;
    this.loading = false;
    moment().locale("nl");
  ...
  get calculateSize() {
    let size_m3 = 0;
    this.contract.units.map((x: any) => (size_m3 += x.size_m3));
    return size_m3;
  }
